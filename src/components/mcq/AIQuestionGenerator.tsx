...
const AIQuestionGenerator: React.FC<AIQuestionGeneratorProps> = ({ onQuestionGenerated }) => {
  ...
  const handleGenerate = async () => {
    ...
    try {
      const { data, error } = await supabase.functions.invoke('generate-mcq-question', {
      ...
      if (data && data.question) {
        ...
        toast({
          title: "Success",
          description: "Question generated successfully! Review and modify as needed."
        });
      } else {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle>Generate MCQ Question with AI</DialogTitle>
        </DialogHeader>
        <div className="space-y-4">
          <div>
            ...
            <Input
              id="topic"
              placeholder="e.g., JavaScript fundamentals, Biology, History..."
              value={topic}
